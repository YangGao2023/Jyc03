  ...
  return (
    <main className="min-h-screen bg-blue-950 text-white">
      <div className="mx-auto flex min-h-screen max-w-3xl items-center justify-center px-4 py-6 sm:px-6 lg:px-8">
        <div className="w-full rounded-[32px] border border-blue-800/40 bg-[linear-gradient(145deg,_rgba(30,64,175,0.94),_rgba(23,37,84,0.92))] p-6 shadow-2xl lg:p-8">
          <p className="text-xs uppercase tracking-[0.35em] text-blue-200">Owner Login</p>
          ...
          <form action="/api/login" method="POST" className="mt-6 rounded-3xl border border-blue-800/40 bg-blue-900/20 p-5">
            ...
            <div className="grid gap-4">
              <label className="text-sm font-medium text-blue-200">
                ...
                <input
                  name="username"
                  className="mt-2 w-full rounded-2xl border border-blue-800/40 bg-blue-950/60 px-4 py-3 text-white outline-none placeholder:text-blue-300"
          ...
          <div className="mt-6 flex flex-wrap gap-3 text-sm">
            <Link href="/" className="rounded-2xl border border-blue-800/40 bg-blue-900/20 px-4 py-2 text-blue-200 hover:bg-blue-800/30">
              返回前台
            </Link>
            <Link href="/dashboard" className="rounded-2xl border border-blue-800/40 bg-blue-900/20 px-4 py-2 text-blue-200 hover:bg-blue-800/30">
              试图进入后台
            </Link>
          </div>
        </div>
